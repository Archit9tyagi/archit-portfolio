...
const projects = [
  ...
  },
  {
    ...
    category: "Full-Stack",
    tools: "Django, Python, Advanced UI",
    description: [
      "Developed an academic notes sharing platform allowing students to upload, download, and review study materials.",
  ...
  {
    title: "IPL Match Analysis & Prediction Platform",
    category: "Machine Learning",
    tools: "Python, Pandas, Scikit-Learn",
    description: [
      "Developed a machine learning platform to analyze IPL match and player performance data.",
